class zcl_werfen_data_gen_ac definition
  public
  final
  create public .
...
class zcl_werfen_data_gen_ac implementation.
...
*last_changed_at       : abp_lastchange_tstmpl;
    ...
    data: lt_acc_categ type table of zwtb_acc_categ,
          ...
          lt_clnts_lib type table of zwtb_clnt_lib,
          lt_libros    type table of zwtb_libros.
...
******** zwtb_acc_categ ********
    ...
    delete from zwtb_acc_categ.
    insert zwtb_acc_categ from table @lt_acc_categ.
...
******** zwtb_categ ********
    ...
    "Delete possible entries; insert new entries
    delete from zwtb_categ.
    insert zwtb_categ from table @lt_catego.
...
******** zwtb_clientes ********
    ...
    "Delete possible entries; insert new entries
    delete from zwtb_clientes.
    insert zwtb_clientes from table @lt_clientes.
...
******** zwtb_clnt_lib
    ...
    "Delete possible entries; insert new entries
    delete from zwtb_clnt_lib.
    insert zwtb_clnt_lib from table @lt_clnts_lib.
...
******** zwtb_libros ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from zwtb_libros.
    insert zwtb_libros from table @lt_libros.
